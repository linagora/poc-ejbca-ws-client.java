 ...
 * 
 */
@WebServiceClient(name = "EjbcaWSService", targetNamespace = "http://ws.protocol.core.ejbca.org/", wsdlLocation = "https://ejbca:8443/ejbca/ejbcaws/ejbcaws?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://ejbca:8443/ejbca/ejbcaws/ejbcaws?wsdl");
